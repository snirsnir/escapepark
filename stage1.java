...
public class stage1 extends AppCompatActivity {
                ...
                if (((String) password).equals("759")) {
                    ...
                    if (temp == 5) {
                        ...
                        sofb.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                greentime = MyFragment.timeleft/1000;
                                ...
                                handler.postDelayed(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        Intent myIntent = new Intent(stage1.this, stage6.class);
                            ...
                            public void onClick(View v) {
                                ...
                                handler.postDelayed(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        Intent myIntent = new Intent(stage1.this, stage2.class);
                                        startActivity(myIntent);
                                    }
                                }, 3000);
                            }
    ...
    public void onBackPressed() {
        if(TIME_LIMIT+backPressed > System.currentTimeMillis()){
            Intent myIntent = new Intent(stage1.this,groups.class);
            startActivity(myIntent);
        }
        else{

...
public class stage5e extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.stage5e);
                            ...
                            public void onClick(View v) {
                                ...
                                handler.postDelayed(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        Intent myIntent = new Intent(stage5e.this, stage6.class);
                            ...
                            public void onClick(View v) {
                                ...
                                handler.postDelayed(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        Intent myIntent = new Intent(stage5e.this, stage1.class);
                                        startActivity(myIntent);
                                    }
                                }, 3000);
                            }
    ...
    public void onBackPressed() {
        if(TIME_LIMIT+backPressed > System.currentTimeMillis()){
            Intent myIntent = new Intent(stage5e.this,groups.class);
            startActivity(myIntent);
        }
        else{

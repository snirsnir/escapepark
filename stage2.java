...
public class stage2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ImageButton ch = (ImageButton) findViewById(R.id.ch);
        ...
        final MediaPlayer tikva  = MediaPlayer.create(this,R.raw.tikva2);
        desc.pause();
        title1.pause();
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String password2 = passwordWrapper.getEditText().getText().toString();
                if(((String) password2).equals("21231")) {
                    ...
                    if (temp == 5) {
                        ...
                        sofb.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                redtime = MyFragment.timeleft/1000;
                                ...
                                handler.postDelayed(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        Intent myIntent = new Intent(stage2.this, stage6.class);
                            ...
                            public void onClick(View v) {
                                ...
                                handler.postDelayed(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        Intent myIntent = new Intent(stage2.this, stage3.class);
                                        startActivity(myIntent);
                                    }
                                }, 3000);
                            }
    ...
    public void onBackPressed() {
        if(TIME_LIMIT+backPressed > System.currentTimeMillis()){
            Intent myIntent = new Intent(stage2.this,groups.class);
            startActivity(myIntent);
        }
        else{

...
public class stage3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String password3 = passwordWrapper.getEditText().getText().toString();
                if(((String) password3).equals("33331")) {
                    ...
                    if (temp == 5) {
                        ...
                        sofb.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                purpletime = MyFragment.timeleft/1000;
                                ...
                                handler.postDelayed(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        Intent myIntent = new Intent(stage3.this, stage6.class);
                            ...
                            public void onClick(View v) {
                                ...
                                handler.postDelayed(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        Intent myIntent = new Intent(stage3.this, stage4.class);
                                        startActivity(myIntent);
                                    }
                                }, 3000);
                            }
                    ...
                    next.setVisibility(View.INVISIBLE);
                    ((TextView) findViewById(R.id.password3)).setText("");
                }
            }
        });
    }
    ...
    public void onBackPressed() {
        if(TIME_LIMIT+backPressed > System.currentTimeMillis()){
            Intent myIntent = new Intent(stage3.this,groups.class);
            startActivity(myIntent);
        }
        else{

...
public class stage4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String password4 = passwordWrapper.getEditText().getText().toString();
                if(((String) password4).equals("784")) {
                    ...
                    if (temp == 5) {
                        ...
                        sofb.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                yellowtime = MyFragment.timeleft/1000;
                                ...
                                handler.postDelayed(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        Intent myIntent = new Intent(stage4.this, stage6.class);
                                    ...
                                    public void run() {
                                        ...
                                        switch (flag){
                                            case 1:
                                                ...
                                                mDatabase.setValue("5");
                                                Intent myIntent2 = new Intent(stage4.this, stage5.class);
                                                startActivity(myIntent2);
                                                break;
                                            case 2:
                                                mDatabase = FirebaseDatabase.getInstance().getReference("green").child("stage");
                                                mDatabase.setValue("4");
                                                Intent myIntent3 = new Intent(stage4.this, stage5b.class);
                                                startActivity(myIntent3);
                                                break;
                                            case 3:
                                                mDatabase = FirebaseDatabase.getInstance().getReference("red").child("stage");
                                                mDatabase.setValue("3");
                                                Intent myIntent4 = new Intent(stage4.this, stage5c.class);
                                                startActivity(myIntent4);
                                                break;
                                            case 4:
                                                mDatabase = FirebaseDatabase.getInstance().getReference("purple").child("stage");
                                                mDatabase.setValue("2");
                                                Intent myIntent5 = new Intent(stage4.this, stage5d.class);
                    ...
                    next.setVisibility(View.INVISIBLE);
                    ((TextView) findViewById(R.id.password4)).setText("");
                }
            }
        });
    }
    ...
    public void onBackPressed() {
        if(TIME_LIMIT+backPressed > System.currentTimeMillis()){
            Intent myIntent = new Intent(stage4.this,groups.class);
            startActivity(myIntent);
        }
        else{
